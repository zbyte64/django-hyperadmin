...
class State(MergeDict):
    ...
    """
    def __init__(self, resource, global_state, meta):
        self.resource = resource
        self.meta = meta
        dictionaries = [{}, global_state]
    ...
    def __copy__(self):
        return self.__class__(self.resource, self.dicts[-1], self.meta)
    ...
    def fork(self, resource=None, global_state=None, data=None, meta=None):
        """
        Return a copy of this state.
        """
        new_state = copy(self)
        if global_state is not None:
            new_state.dicts = [{}, global_state] + list(new_state.dicts)
        else:
            new_state.dicts = [{}] + list(new_state.dicts)
